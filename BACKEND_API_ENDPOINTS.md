...
| GET | `https://fangfangfang.top/admin/user/list` | `https://dev.fangfangfang.top/admin/user/list` | `http://localhost:8080/admin/user/list` | User list, commonly with `page`, `size`, `nickName` |
...
| POST | `https://fangfangfang.top/api/user/refresh` | `https://dev.fangfangfang.top/api/user/refresh` | `http://localhost:8080/api/user/refresh` | Refresh token, intentionally still shared with user APIs |
...
| PATCH | `https://fangfangfang.top/admin/topic/{id}` | `https://dev.fangfangfang.top/admin/topic/{id}` | `http://localhost:8080/admin/topic/{id}` | Update topic |
| DELETE | `https://fangfangfang.top/admin/topic/{id}` | `https://dev.fangfangfang.top/admin/topic/{id}` | `http://localhost:8080/admin/topic/{id}` | Delete topic |
## Term
...
There is likely a bug in `src/api/axios.js`: the token refresh logic calls ``${baseURL}/api/user/refresh``, but `baseURL` is not defined in that file.
